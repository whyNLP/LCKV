...
accelerate launch run_clm.py \
    ...
    --config_overrides num_encoders=8,num_trained_encoders=1,layer_types=0_3_3_3_6_6_6_7 \
    ...
    --report_to none \
    --run_name llamatiny-group-3090-test \
    --overwrite_output_dir \
    --output_dir outputs/llamatiny-group-3090-test
...
python run_clm.py \
    --model_name_or_path outputs/llamatiny-group-3090-test \
    --tokenizer_name TinyLlama/TinyLlama-1.1B-intermediate-step-955k-token-2T \
    --dataset_name wikitext \
    --dataset_config_name wikitext-103-raw-v1 \
