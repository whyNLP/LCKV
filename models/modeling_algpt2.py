...
"""PyTorch OpenAI GPT-2 model. An ALBERT variation, following
https://wandb.ai/bkkaggle/lm-finetuning/reports/Pretraining-a-124-M-Parameter-GPT-2-Language-Model--VmlldzoyMjg4NzA#code
"""
...
class ALGPT2PreTrainedModel(PreTrainedModel):
    """
    ...
    def _set_gradient_checkpointing(self, module, value=False):
        if isinstance(module, ALGPT2Model):
...
class ALGPT2Model(ALGPT2PreTrainedModel):
    ...
    def __init__(self, config):
        ...
        self.h = GPT2Block(config, layer_idx=0)
