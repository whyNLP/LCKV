"""
Adapted from: https://github.com/OptimalScale/LMFlow/blob/main/src/lmflow/utils/flash_attention/gpt2_flash_attention.py
Original Author: Wei Liu
"""
...
def forward(
    ...
    # XXX: I don't know what this is for, so I just comment it out
    # assert not use_cache, "Use cache is not supported"
    # present = None
    ...
    if key_padding_mask is None:
        ...
        output = flash_attn_unpadded_qkvpacked_func(
            qkv, cu_q_lens, max_s, p, softmax_scale=None, causal=True
        )
        ...
        output_unpad = flash_attn_unpadded_qkvpacked_func(
            x_unpad, cu_q_lens, max_s, p, softmax_scale=None, causal=True
        )
        output = rearrange(
            pad_input(
